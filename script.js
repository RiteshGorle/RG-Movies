...
const createElements = (x) => {
    ...
    text.className= "text"
    text.innerHTML = `<h6 style="color:white;">${x.original_title}</h6> <div class="card-panel" style="background:#810000;color:white;font-size:12px;"> ${(x.vote_average)}/10 <span id=stars>  ${getStars(x.vote_average)}</span> </div>`
